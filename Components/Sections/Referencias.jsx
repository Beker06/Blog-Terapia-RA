        ...
        <div className='flex w-full mt-[8%] justify-center'>
          <div className='flex flex-col text-white w-[70%] text-justify text-lg mx-[10%]'>
            ...
            <ul className='list-disc'>
              ...
              <br/>
              <li>Psicoveritas. (s. f.). Realidad virtual y psicología. Recuperado el 14 de marzo de 2023, de <a href='https://psicoveritas.com/realidad-virtual/' target="_blank" className='underline'>https://psicoveritas.com/realidad-virtual/</a></li>
              <br/>
              <li>Inmersys. (s. f.). 5 increíbles ejemplos de cómo la realidad virtual puede ayudar en terapias. [Blog post]. Recuperado el 04 de marzo de 2023, de <a href='https://blog.inmersys.com/5-incre%C3%ADbles-ejemplos-de-c%C3%B3mo-la-realidad-virtual-puede-ayudar-en-terapias' target="_blank" className='underline'>https://blog.inmersys.com/5-incre%C3%ADbles-ejemplos-de-c%C3%B3mo-la-realidad-virtual-puede-ayudar-en-terapias</a></li>
              <br/>
              <li>Centro Bonanova. (s. f.). Realidad virtual y psicología. Recuperado el \04 de marzo de 2023, de <a href='https://www.centrobonanova.com/tipos-de-tratamiento/realidad-virtual-psicologia/' target="_blank" className='underline'>https://www.centrobonanova.com/tipos-de-tratamiento/realidad-virtual-psicologia/</a></li>
              <br/>
              <li>Euroinnova. (s. f.). ¿Cuáles son los pasos para realizar una investigación? [Blog post]. Recuperado el 04 de marzo de 2023, de <a href='https://www.euroinnova.edu.es/blog/cuales-son-los-pasos-para-realizar-una-investigacion' target="_blank" className='underline'>https://www.euroinnova.edu.es/blog/cuales-son-los-pasos-para-realizar-una-investigacion</a></li>
              <br/>
